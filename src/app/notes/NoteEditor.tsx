...
export default function NoteEditor({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Top toolbar */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0a0a0a] flex-shrink-0">
      ...
      {/* Formatting toolbar */}
      {!isTrash && (
        <div className="flex items-center gap-0.5 px-3 py-1.5 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-[#111111] flex-shrink-0 overflow-x-auto">
      ...
      {/* Status bar */}
      <div className="flex items-center justify-between px-4 py-1.5 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-[#111111] text-[10px] text-gray-400 flex-shrink-0">
