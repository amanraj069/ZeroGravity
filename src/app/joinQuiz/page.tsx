        ...
        <main className="flex-1 flex justify-center px-4 sm:px-6 pt-0 pb-12 sm:pb-16 min-h-0">
          <div className="max-w-6xl mx-auto w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 items-stretch">
              ...
              <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-5 sm:p-8 lg:p-10 border border-black dark:border-gray-700 shadow-lg h-auto lg:h-[75dvh] flex flex-col justify-start order-1 lg:order-2 rounded-xl">
                <div className="mb-4 sm:mb-6">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                    Enter your code and name to join the quiz
                  </p>
                </div>
                <div className="space-y-5 sm:space-y-6 lg:space-y-8 flex-1 flex flex-col justify-center">
                  <div>
                  ...
                  <button
                    ...
                    onClick={handleJoin}
                    disabled={joinCode.trim().length !== 6 || !name.trim()}
                  >
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 lg:p-8 border border-black dark:border-gray-700 min-h-[350px] h-[40vh] sm:h-[50dvh] lg:h-[75dvh] flex flex-col order-2 lg:order-1 rounded-xl">
                <div className="mb-4 sm:mb-6">
                  <h3 className="text-lg sm:text-xl font-light text-gray-900 dark:text-white mb-1 sm:mb-2">
                    Choose Your Avatar
                  </h3>
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-3 gap-3 md:gap-6 p-2 sm:p-4">
                    {avatars.map((avatar) => (
                      <button
                        ...
                        className={`relative w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 md:w-28 md:h-28 rounded-full overflow-hidden transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-300 dark:focus:ring-orange-600 mx-auto ${selectedAvatar === avatar
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 min-h-[75vh] lg:min-h-[70vh] flex flex-col rounded-xl overflow-hidden">
              ...
              <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/80">
                <div className="flex items-center justify-between gap-4 mb-4">
                  ...
                  {/* Timer */}
                  <div
                    className={`h-8 sm:h-10 px-3 sm:px-4 font-mono text-sm sm:text-lg font-bold flex items-center flex-shrink-0 border ${timeLeft <= 10
                    ...
                    {participants.length > 0 ? (
                      <div className="grid grid-cols-1 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-7 gap-2 sm:gap-4 md:gap-6">
                        {participants.map((p) => (
                          <div
                            key={p.quizUserId}
                            className={`flex flex-row sm:flex-col items-center sm:text-center p-2 sm:p-3 transition-all rounded-xl gap-4 sm:gap-0 ${p.quizUserId === joined?.quizUserId
