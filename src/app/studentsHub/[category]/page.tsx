...
export default function CategoryPage() {
  ...
  return (
    <DashboardLayout>
      {/* Search Bar - Sticky at top on desktop, appears after header on mobile */}
      <div className="hidden sm:block sticky top-[68px] z-20 bg-white dark:bg-gray-900 -mx-4 px-4 py-4 border-b border-gray-200 dark:border-gray-800 mb-6 shadow-sm">
      ...
      <div className="mt-4">
        <div className="mb-2 sm:mb-8 flex flex-row items-start md:items-center justify-between gap-3 md:gap-4">
          <Link
            href="/studentsHub"
        ...
        {/* Search Bar - Mobile version, appears after header */}
        <div className="sm:hidden mb-6 sticky top-[60px] z-20 bg-white dark:bg-gray-900 -mx-4 px-4 py-3 border-b border-gray-200 dark:border-gray-800 shadow-sm">
