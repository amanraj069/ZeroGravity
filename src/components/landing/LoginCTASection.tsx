...
export default function LoginCTASection() {
  return (
    <AnimatedCTA className="relative bg-gray-50 dark:bg-[#111114] py-24 sm:py-32 border-t border-gray-100 dark:border-white/[0.03] transition-colors duration-1000 overflow-hidden">
      ...
      <AnimatedSection className="relative z-10 max-w-4xl mx-auto text-center px-8">
        <div className="space-y-8">
          <AnimatedSection>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-light text-black dark:text-white mb-6 tracking-tight leading-tight">
              Ready to <span className="font-normal italic">break free?</span>
            </h2>
          </AnimatedSection>
          
          <AnimatedSection delay={0.1}>
            <p className="text-gray-600 dark:text-gray-400 text-lg sm:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <AnimatedSection delay={0.2}>
            <div className="flex justify-center">
              <Link
                href="/login"
                className="group relative inline-flex items-center justify-center px-10 py-4 font-medium tracking-wide text-white dark:text-black transition-all duration-300 ease-in-out"
              >
